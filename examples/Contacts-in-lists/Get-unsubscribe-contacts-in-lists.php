...
/**
 * https://app.smartemailing.cz/docs/api/v3/index.html#api-Contacts_in_lists-Get_unsubscribed_Contacts_in_list__including_blacklisted
 */
// Call Request
$list = (new SmartEmailing('usrname', 'apiKey'))
    ->contactLists()
    ->getAllUnsubscribedContacts(1);
